...
<svelte:head>
  <title>Tietoa minusta | Arde Media</title>
</svelte:head>
...
<Container style="bg-base-100 bg-[url('/bg-pattern.svg')]">
  ...
  <div class="flex flex-row">
    <div class="p-5 card shadow-lg bg-base-100 md:w-1/2">
      ...
      <p class="">
        ...
        kehittämisen ja ylläpidon. Ensisijainen osaamiseni on web-teknologioiden ja pilvipalvelujen
        puolella, mutta lisäksi mobiilihommat luonnistuu vankan Android-kokemuksen johdosta. Olen
        aina ollut kiinnostunut teknologiasta ja tietokoneista, jonka takia seuraan tiiviisti alan
        trendejä ja uutisia. Koodailun vastapainoksi vapaa-aikani kuluu salibandyn ja muun pelailun
        parissa.
      </p>
    </div>
  ...
  <p>
    Lasken osaamiseksi sen, että olen toteuttanut projektin valmiiksi, jossa olen käyttänyt kyseistä
    teknologiaa. Näiden lisäksi projektinhallintatyökalut kuten Trello, Jira ja Github Projects
    kuuluvat työkalujeni piiriin. Käyttöjärjestelmistä Windows (+WSL) on lähellä sydäntä. Myös
    Linuxin käyttö on hanskassa eli voin työskennellä molemmilla kummalla tahansa.
  </p>
  <div>
    <TechTable />
  </div>
  ...
  <p>
    ...
    visualisoinnista (UI design) sekä toteutuksesta. Kokemusta on siis monipuolisesti ihan
  ...
  <p>
    ...
    ohjelmistoalalla. Minun erityisosaaminen teknologioiden osalta on GWT (Google Web Toolkit), joka
    on harvinaisempi teknologia nykypäivänä. Vahvuutena koen Full Stack -ohjelmistokehityksen, jonka
    ansiosta osaamista löytyy jokaiselta ohjelmistokehityksen osa-alueelta.
    <br /><br />
    Tarvittaessa hyödynnettäviä taitojani on videoeditointi ja kuvankäsittely, joista minulla on vuosien
    kokemus. Olen toteuttanut yli 50 videoprojektia vapaa-ajallani. Näiden lisäksi kokemusta ja ymmärrystä
    löytyy lisäksi jonkin verran Facebook-markkinoinnista ja hakukoneoptimoinnista.
  </p>
  <div class="flex flex-row flex-wrap py-5">
    ...
    <div class="flex-col md:w-1/2">
      ...
      <HistoryItem
        ...
        company="Turun ammattikorkeakoulu"
      />
      <HistoryItem
        role="Insinööri (AMK)"
        year="2013-2017 - Mediatekniikka"
        company="Jyväskylän ammattikorkeakoulu"
      />
      <HistoryItem
        role="Elektroniikka-asentaja + Ylioppilas"
        year="2008-2012 - ICT-lukio (kaksoistutkinto)"
        company="Kainuun ammattiopisto ja Kajaanin lukio"
      />
    </div>
  </div>
  <Divider />
